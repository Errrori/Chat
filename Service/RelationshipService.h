...
public:
	...
	drogon::Task<> SendFriendRequest(const std::string& requester_uid, const std::string& acceptor_uid, const std::string& message);
	drogon::Task<int64_t> ProcessFriendRequest(const std::string& requester_uid, const std::string& acceptor_id, int status);
