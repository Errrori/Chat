...
项目使用 [config.json](file://c:\Repository0428\ChatServer\ChatServer\config.json) 文件进行配置。
...
## 开发文档和接口文档
部分开发文档: [项目部分开发文档](https://veryshuai666.github.io/ChatDocs/)
接口文档: 
