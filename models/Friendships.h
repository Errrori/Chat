...
class Friendships
{
  public:
     ...
     */
    explicit Friendships(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Friendships(const Json::Value &pJson) noexcept(false);
     ...
     */
    Friendships(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Friendships>;
    friend drogon::orm::BaseBuilder<Friendships, true, true>;
    friend drogon::orm::BaseBuilder<Friendships, true, false>;
    friend drogon::orm::BaseBuilder<Friendships, false, true>;
    friend drogon::orm::BaseBuilder<Friendships, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Friendships>;
#endif
