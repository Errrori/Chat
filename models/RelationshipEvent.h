...
class RelationshipEvent
{
  public:
     ...
     */
    explicit RelationshipEvent(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit RelationshipEvent(const Json::Value &pJson) noexcept(false);
     ...
     */
    RelationshipEvent(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    RelationshipEvent() = default;
  ...
  private:
    friend drogon::orm::Mapper<RelationshipEvent>;
    friend drogon::orm::BaseBuilder<RelationshipEvent, true, true>;
    friend drogon::orm::BaseBuilder<RelationshipEvent, true, false>;
    friend drogon::orm::BaseBuilder<RelationshipEvent, false, true>;
    friend drogon::orm::BaseBuilder<RelationshipEvent, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<RelationshipEvent>;
#endif
