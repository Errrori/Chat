...
class ChatRecords
{
  public:
     ...
     */
    explicit ChatRecords(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ChatRecords(const Json::Value &pJson) noexcept(false);
     ...
     */
    ChatRecords(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<ChatRecords>;
    friend drogon::orm::BaseBuilder<ChatRecords, true, true>;
    friend drogon::orm::BaseBuilder<ChatRecords, true, false>;
    friend drogon::orm::BaseBuilder<ChatRecords, false, true>;
    friend drogon::orm::BaseBuilder<ChatRecords, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<ChatRecords>;
#endif
