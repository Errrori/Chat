...
class Notifications
{
  public:
    ...
    /**  For column notification_id  */
    ///Get the value of the column notification_id, returns the default value if the column is null
    const std::string &getValueOfNotificationId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getNotificationId() const noexcept;
    ///Set the value of the column notification_id
