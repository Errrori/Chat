...
Messages::Messages(const Row &r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0)
    {
        ...
        {
            updateTime_=std::make_shared<int64_t>(r["update_time"].as<int64_t>());
        }
    }
    else
    {
        ...
        if(!r[index].isNull())
        {
            updateTime_=std::make_shared<int64_t>(r[index].as<int64_t>());
        }
    }
...
Messages::Messages(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[8].empty() && pJson.isMember(pMasqueradingVector[8]))
    {
        ...
        {
            createTime_=std::make_shared<int64_t>((int64_t)pJson[pMasqueradingVector[8]].asInt64());
        }
    }
    if(!pMasqueradingVector[9].empty() && pJson.isMember(pMasqueradingVector[9]))
    {
        ...
        {
            updateTime_=std::make_shared<int64_t>((int64_t)pJson[pMasqueradingVector[9]].asInt64());
        }
    }
}
...
Messages::Messages(const Json::Value &pJson) noexcept(false)
{
    ...
    if(pJson.isMember("update_time"))
    {
        ...
        {
            updateTime_=std::make_shared<int64_t>((int64_t)pJson["update_time"].asInt64());
        }
    }
}
...
const int64_t &Messages::getValueOfCreateTime() const noexcept
{
    static const int64_t defaultValue = int64_t();
    if(createTime_)
        return *createTime_;
...
const std::shared_ptr<int64_t> &Messages::getCreateTime() const noexcept
{
    return createTime_;
}
void Messages::setCreateTime(const int64_t &pCreateTime) noexcept
{
...
const std::shared_ptr<int64_t> &Messages::getUpdateTime() const noexcept
{
    return updateTime_;
}
void Messages::setUpdateTime(const int64_t &pUpdateTime) noexcept
{
...
Json::Value Messages::toJson() const
{
    ...
    if(getUpdateTime())
    {
        ret["update_time"]=(Json::Int64)getValueOfUpdateTime();
    }
    else
    {
    ...
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 10)
    {
        ...
        if(!pMasqueradingVector[8].empty())
        {
            if(getCreateTime())
            {
                ret[pMasqueradingVector[8]]=(Json::Int64)getValueOfCreateTime();
            }
            else
            {
        ...
        if(!pMasqueradingVector[9].empty())
        {
            if(getUpdateTime())
            {
                ret[pMasqueradingVector[9]]=(Json::Int64)getValueOfUpdateTime();
            }
            else
            {
