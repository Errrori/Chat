...
class GroupChats
{
  public:
     ...
     */
    explicit GroupChats(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit GroupChats(const Json::Value &pJson) noexcept(false);
     ...
     */
    GroupChats(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<GroupChats>;
    friend drogon::orm::BaseBuilder<GroupChats, true, true>;
    friend drogon::orm::BaseBuilder<GroupChats, true, false>;
    friend drogon::orm::BaseBuilder<GroupChats, false, true>;
    friend drogon::orm::BaseBuilder<GroupChats, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<GroupChats>;
#endif
