...
class Threads
{
  public:
     ...
     */
    explicit Threads(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Threads(const Json::Value &pJson) noexcept(false);
     ...
     */
    Threads(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Threads>;
    friend drogon::orm::BaseBuilder<Threads, true, true>;
    friend drogon::orm::BaseBuilder<Threads, true, false>;
    friend drogon::orm::BaseBuilder<Threads, false, true>;
    friend drogon::orm::BaseBuilder<Threads, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Threads>;
#endif
